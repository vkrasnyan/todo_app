...
Демонстрационный проект backend-приложения для управления задачами с REST API.
В рамках проекта подготовлены технические материалы, включая описание архитектуры, API-документацию и инструкции по запуску приложения.
Проект представляет собой REST API для управления задачами с возможностью делегирования прав другим пользователям. 
Реализован на FastAPI + SQLAlchemy + Alembic + PostgreSQL с акцентом на безопасность, чистую архитектуру и гибкую систему прав доступа.
...
[Описание API](https://github.com/vkrasnyan/todo_app/blob/master/docs/api_reference.md)

Описание моделей и базы данных _(в процессе)_

Часто задаваемые вопросы _(в процессе)_
